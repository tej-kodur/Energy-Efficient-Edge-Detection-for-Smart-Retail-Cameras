#!/usr/bin/env python3
"""
Train PiDiNet‑Lite (carv4) tiny model.
"""
...
from src.models import PiDiNetLite


def train(net, loader, epochs, lr, device):
...
def main(args):
    ...
    train(net, dl_biped, 12, 1e-3, device)
    train(net, dl_rpc,   12, 8e-4, device)
...
if __name__ == "__main__":
    ...
    ap.add_argument("--ckpt", default="results/checkpoints/pidinet_best.pth", type=Path)
    main(ap.parse_args())
